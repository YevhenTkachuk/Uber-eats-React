...
export function Autorisations() {
    return (
        <div className="authorisation-cabinet__wrapper">
            ...
            <button className="authorisation-cabinet authorisation-cabinet--black">Register</button>
            <a href="https://www.ubereats.com/ru-UA/checkout/" className="authorisation-cabinet__basket">
